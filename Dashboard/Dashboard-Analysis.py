...
product_summary = pd.read_csv('Dashboard/product_summary.csv')
city_sales = pd.read_csv('Dashboard/city_sales.csv')
new_customers_trend = pd.read_csv('Dashboard/new_customers_trend.csv')
